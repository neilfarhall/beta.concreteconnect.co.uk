...
ccradix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of ccradix theme and run the following commands:
`nvm use`
...
`drush en ccradix -y`
`drush config-set system.theme default ccradix -y`
