  ...
  public function videoFilterTestCases() {
    return [
      'Standard embed code' => [
        ...
        '<p>Content.</p><div class="video-embed-field-provider-youtube video-embed-field-responsive-video"><iframe width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen" referrerpolicy="strict-origin-when-cross-origin" src="https://www.youtube.com/embed/uNRtZDAS0xI?autoplay=1&amp;start=0&amp;rel=0&amp;mute=1"></iframe></div><p>More content.</p>',
      ],
      'Embedded vimeo video' => [
        ...
        '<p>Content.</p><div class="video-embed-field-provider-vimeo video-embed-field-responsive-video"><iframe width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen" src="https://player.vimeo.com/video/18352872?autoplay=1&amp;muted=1"></iframe></div><p>More content.</p>',
      ],
      ...
      'No wrapping paragraphs tags' => [
        ...
        '<div class="video-embed-field-provider-vimeo video-embed-field-responsive-video"><iframe width="854" height="480" frameborder="0" allowfullscreen="allowfullscreen" src="https://player.vimeo.com/video/18352872?autoplay=1&amp;muted=1"></iframe></div>',
      ],
      'Invalid URL' => [
      ...
      'XSS Width/Height' => [
        ...
        '<p>Content.</p><div class="video-embed-field-provider-youtube video-embed-field-responsive-video"><iframe width="&quot;&gt;test" height="&quot;&gt;test" frameborder="0" allowfullscreen="allowfullscreen" referrerpolicy="strict-origin-when-cross-origin" src="https://www.youtube.com/embed/uNRtZDAS0xI?autoplay=1&amp;start=0&amp;rel=0&amp;mute=1"></iframe></div><p>More content.</p>',
      ],
      'Empty settings' => [
