...
class AdvancedDatalayerWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    // Hide default value form on field config form,
    // default values should be taken from global settings on create/edit form.
    if (!empty($build_info['base_form_id']) && $build_info['base_form_id'] !== 'field_config_form') {
